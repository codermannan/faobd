...
<head>
	...
	<meta name="description" content="Star Football Academy E learning" />
...
<body class="page-body login-page login-form-fall" data-url="https://www.starfootballacademy.com/">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content" style="width:100%;">
			...
			<a href="<?php echo base_url();?>" class="logo">
				<img src="uploads/rehan.png" height="200" alt="" />
			</a>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="password" class="form-control" name="password" id="password" placeholder="Password" autocomplete="off" />
                                                 <div class="input-group-addon">
                                                         <a href="#" toggle="#password-field" class="entypo-eye toggle-password"></a>
                                                 </div>
					</div>
